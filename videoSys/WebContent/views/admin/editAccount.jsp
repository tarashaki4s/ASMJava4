	...
	<div id="app">
		...
		<div id="main">
			...
			<div class="row">
				...
				<div class="col-9">
					<span>UserID: </span><input value="${currentUser.userID}" type="text" name="userID" readonly="readonly" 
						class="videoInput" style="width: 100%"><br>
					<br> <span>password: </span><input value="${currentUser.password}" type="text" required="required"
						name="password" class="videoInput" style="width: 100%"><br>
					<br> <span>Email: </span><input value="${currentUser.email}" type="email" name="email" required="required"
						class="videoInput" style="width: 100%"><br>
					<br>
					<br> <span>Full Name: </span><input value="${currentUser.fullName}" type="text" name="fullName" required="required"
						class="videoInput" style="width: 100%"><br>
					<br>
					
					<button formaction="../account/edit" class="btnUpdate">Update</button>
				</div>
			</div>
