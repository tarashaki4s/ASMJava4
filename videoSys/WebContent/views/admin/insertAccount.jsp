	...
	<div id="app">
		...
		<div id="main">
				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							<h3>User</h3>
							<p class="text-subtitle text-muted">Thêm User</p>
						</div>
			...
			<div class="row">
				...
				<div class="col-9">
					<span>UserID: </span><input type="text" name="userID" required="required"
						class="videoInput" style="width: 100%"><br>
					<br> <span>password: </span><input type="text" required="required"
						name="password" class="videoInput" style="width: 100%"><br>
					<br> <span>Email: </span><input type="email" name="email" required="required"
						class="videoInput" style="width: 100%"><br>
					<br>
					<br> <span>Full Name: </span><input type="text" name="fullName" required="required"
						class="videoInput" style="width: 100%"><br>
					<br>
